...
# save df
write.csv(mimic.df, "C:/Users/thijs/Documents/Studie/Master/MSBBSS 11 - Thesis/R-data/Master Thesis/mimic_df_raw_times.csv")
```
...
write.csv(mimic.df.stand.t, "C:/Users/thijs/Documents/Studie/Master/MSBBSS 11 - Thesis/R-data/Master Thesis/mimic_df_standtimes.csv")
...
write.csv(cont.times, "C:/Users/thijs/Documents/Studie/Master/MSBBSS 11 - Thesis/R-data/Master Thesis/mimic_cont_explain.csv" )
write.csv(timss.cont, "C:/Users/thijs/Documents/Studie/Master/MSBBSS 11 - Thesis/R-data/Master Thesis/mimic_cont_detect.csv")
```



```{r}
# screen visits as process data:
freq.df <- rbind(timss.freq.proto[[1]], timss.freq.proto[[2]], timss.freq.proto[[3]], timss.freq.proto[[4]], timss.freq.proto[[5]], timss.freq.proto[[6]], timss.freq.proto[[7]])

# adjust person_id
freq.df$person_id <- paste(freq.df$IDCNTRY, freq.df$IDSTUD, sep = "")
freq.df <- freq.df %>% dplyr::select(-IDCNTRY)


# Combine with other df and make numeric values of frequencies.
mimic.freq <- join(mimic.df.stand.t, freq.df, by = "person_id")
for(i in 80:107){
mimic.freq[,i] <- as.numeric(mimic.freq[,i])  
}

write.csv(mimic.freq, "C:/Users/thijs/Documents/Studie/Master/MSBBSS 11 - Thesis/R-data/Master Thesis/mimic_freq_explain.csv")
```
